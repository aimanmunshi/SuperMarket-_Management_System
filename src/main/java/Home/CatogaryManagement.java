 ...
 * @author yashr
 */
public class CatogaryManagement extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("CATOGARY MANAGEMENT");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CatogaryManagement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
